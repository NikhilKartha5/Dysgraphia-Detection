          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Boosts Academic Confidence</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Identifying dysgraphia early helps students overcome
                writing challenges and build self-assurance in their abilities
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Empowers Parents & Educators</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Early detection allows parents and teachers to provide targeted interventions,
                ensuring the right support for each child.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Reduces Learning Frustration</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Struggling with handwriting can lead to frustration and anxiety.
                Early identification helps prevent these challenges from escalating.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Improves Classroom Engagement </span>
              </h3>
              <p className="text-[15px] text-gray-400">
                When students receive the help they need,
                they participate more actively in learning, improving overall academic performance.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span> Enables Personalized Learning Plans</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                With an early diagnosis,
                educators can implement tailored teaching strategies that cater to a child’s specific needs.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Enhances Long-Term Development</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Early support fosters essential motor and cognitive skills,
                laying a strong foundation for future academic and personal growth.
              </p>
            </article>
          </div>
        </div>
